...
class Employee(db.Model):
    ...
    # Relationship mapping to the employee to related reviews
...
class Onboarding(db.Model):
    ...
    employee_id =db.Column(db.Interger, db.ForeignKey('employees.id'))
...
class Review(db.Model):
    ...
    #Foreign key stores the Emploee Id
    employee_id = db .Column(db.ForeignKey('employees.id'))
